...
public class CarService {
    ...
    public Car findById(Long id) {
         ...
         */
        String getPriceById = priceClient.getPrice(id);
        car.setPrice(getPriceById);
         ...
         */
        Location getLocation = car.getLocation();
        Location getAddress = mapsClient.getAddress(getLocation);
        car.setLocation(getAddress);
